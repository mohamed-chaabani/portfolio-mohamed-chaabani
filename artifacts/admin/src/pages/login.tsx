  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#060d14' }}>
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-white/10 p-8" style={{ background: '#0a1628' }}>
          <div className="text-center mb-8">
            <div className="text-4xl mb-3">⚡</div>
            <h1 className="text-2xl font-bold text-white">Portfolio Admin</h1>
            <p className="text-sm mt-1" style={{ color: '#6b7280' }}>أدخل كلمة المرور للوصول للوحة التحكم</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                style={{ background: '#060d14', borderColor: error ? '#ef4444' : '#1e3a5f' }}
                required
              />
          ...
          <p className="text-xs text-center mt-6" style={{ color: '#374151' }}>
            الـ secret الافتراضي: <span className="font-mono text-cyan-600">admin123</span>
          </p>
        </div>
      </div>
    </div>
